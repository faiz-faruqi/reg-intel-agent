...
**Evaluation mode:** live  |  **Model under test:** OpenRouter/GLM-5.2
...
- **Generation model:** OpenRouter/GLM-5.2
...
| Metric | Score |
|---|---|
| Faithfulness (groundedness) | 0.261 |
| Answer relevancy | 0.858 |
| Context precision | 0.564 |
| Context recall | 0.551 |
...
|---|---|---|---|
| Q01 | osfi_e23 | answerable | faith=0.619, relevance=0.827, precision=0.833, recall=0.667 |
| Q02 | osfi_e23 | answerable | faith=0.000, relevance=0.778, precision=0.000, recall=0.000 |
| Q03 | osfi_e23 | answerable | faith=0.936, relevance=0.841, precision=1.000, recall=0.667 |
| Q04 | osfi_e23 | answerable | faith=0.000, relevance=0.817, precision=1.000, recall=1.000 |
| Q05 | osfi_e23 | answerable | faith=0.000, relevance=0.867, precision=1.000, recall=0.500 |
| Q06 | nist_ai_rmf | answerable | faith=0.000, relevance=0.941, precision=1.000, recall=1.000 |
| Q07 | nist_ai_rmf | answerable | faith=0.000, relevance=0.877, precision=1.000, recall=0.500 |
| Q08 | eu_ai_act | answerable | faith=0.683, relevance=0.882, precision=0.000, recall=0.500 |
| Q09 | iso_42001 | answerable | faith=0.043, relevance=0.698, precision=1.000, recall=0.333 |
| Q10 | ai_governance | answerable | faith=0.708, relevance=1.000, precision=0.500, recall=0.500 |
| Q11 | ai_governance | answerable | faith=0.240, relevance=1.000, precision=0.000, recall=0.000 |
| Q12 | ai_governance | answerable | faith=0.000, relevance=0.741, precision=0.000, recall=1.000 |
| Q13 | ai_governance | answerable | faith=0.167, relevance=0.885, precision=0.000, recall=0.500 |
| Q14 | out_of_scope | out-of-scope | correct refusal |
| Q15 | out_of_scope | out-of-scope | correct refusal |

## 5. Control Assessment and Regulatory Mapping

| Control | Name | Observed | Status | NIST AI RMF | OSFI E-23 |
|---|---|---|---|---|---|
| CTL-01 | Output groundedness / faithfulness | 0.261 agg · 12/13 below 0.8 | ATTENTION | MEASURE 2.5, 2.9 (validity, reliability, fact-checking) | Validation - conceptual soundness and accuracy of outputs |
| CTL-02 | Answer relevance | 0.858 agg · 3/13 below 0.8 | ATTENTION | MEASURE 2.3 (performance against intended use) | Design/Development - fitness for intended purpose |
| CTL-03 | Retrieval precision | 0.564 agg · 6/13 below 0.75 | ATTENTION | MAP 3.3 / MEASURE 2.5 (data and pipeline quality) | Data - quality and relevance of model inputs |
| CTL-04 | Retrieval recall | 0.551 agg · 10/13 below 0.7 | ATTENTION | MEASURE 2.5 (completeness and reliability) | Data - completeness of inputs supporting the decision |
| CTL-05 | Scope / refusal correctness | 1.000 | PASS | GOVERN 1.1 / MANAGE 1.1 (use within intended context) | Governance - models used within stated intended use and limits |
...
Overall residual risk for the assessed scope is rated **ELEVATED**, based on 4 control(s) passing, 4 requiring attention, and 0 not measured in this run. Residual risk should be re-evaluated against the institution's defined risk appetite and any third-party model-risk considerations.
